...
def _page_values(product: dict) -> dict[str, str]:
    ...
    description = (
        ...
        "$12 download in five JPEG ratios. No physical print or frame."
    )
    product_description = (
    ...
    plain_values = {
        "PAGE_TITLE": f"{title} | $12 Download | ARCHIVE-35",
