...
(function() {
    var CONFIG = {
        compName: "A35_Square_1x1",
        compWidth: 1080, compHeight: 1080,
        compDuration: 15, compFPS: 30,
        moveTime: 13,   // camera moves for this long
        holdTime: 2,    // then holds on final photo
        numPhotos: 10,
        corridorWidth: 1000, frameSpacing: 700,
        frameWidth: 440, frameHeight: 293, frameBorder: 30,
        camStartZ: 500, camEndZ: -6000, camFOV: 50,
    ...
    try {
        ...
        alert(
            ...
            "1080x1080 | Instagram Feed / Facebook Feed\n\n" +
