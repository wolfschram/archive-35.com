/*
    ...
    FORMAT:   1080x1920
    DURATION: 15 seconds (13s move + 2s hold on final photo)
...
(function() {
    var CONFIG = {
        compName: "A35_Portrait_9x16",
        compWidth: 1080, compHeight: 1920,
        compDuration: 15, compFPS: 30,
        moveTime: 13,   // camera moves for this long
        holdTime: 2,    // then holds on final photo
        numPhotos: 8,
        corridorWidth: 900, frameSpacing: 800,
        frameWidth: 420, frameHeight: 280, frameBorder: 30,
        camStartZ: 400, camEndZ: -5500, camFOV: 55,
    ...
    try {
        ...
        urlText.property("ADBE Transform Group").property("ADBE Position").setValue([cx, CONFIG.compHeight - 80]);
        ...
        nameText.property("ADBE Transform Group").property("ADBE Position").setValue([cx, 60]);
        ...
        alert(
            ...
            "1080x1920 | Instagram Reels / TikTok / YouTube Shorts\n\n" +
